...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/roomPage.css">
...
<div class="container room-container">
    ...
    <div style="display: flex; justify-content: center; margin-top: 2rem;">
        <a href="${pageContext.request.contextPath}/room/${room.id}/book" style="text-decoration: none;">
        ...
        <c:if test="${not empty sessionContext && sessionContext.role==hotelRole && sessionContext.id==room.hotel.id}">
            <a href="${pageContext.request.contextPath}/room/${room.id}/edit" style="text-decoration: none;">
                <button style="background-color: #4CAF50; color: white; padding: 12px 20px; border: none;
                            border-radius: 4px; cursor: pointer; font-size: 16px; width: 130px; margin: 2px">
                    Edit
                </button>
    ...
    <h3>Hotel Image</h3>
    <a href="${pageContext.request.contextPath}/hotel/${room.hotel.id}">
