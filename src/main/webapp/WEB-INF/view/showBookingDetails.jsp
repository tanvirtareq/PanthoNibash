...
<div class="container-xxl booking-info">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="row">
        <div class="col-md-4 ">
          <img src="data:image/jpeg;base64,${booking.guestImageBase64Image}" alt="Guest Photo" class="guest-photo">
        </div>
        <div class="col-md-8 ">
        ...
        <div class="row">
          <div class="col-md-4">
            <a href="/customer/${booking.customer.id}">
              <img src="data:image/jpeg;base64,${booking.customer.profilePicBase64Image}" alt="Customer Photo" class="guest-photo">
            </a>
          </div>
          <div class="col-md-8">
      ...
      <div class="row">
        <div class="col-md-4">
          <a href="/room/${booking.room.id}">
            <img src="data:image/jpeg;base64,${booking.room.roomImageBase64Image}" alt="Room Photo" class="room-photo">
          </a>
        </div>
        <div class="col-md-8">
      ...
      <div class="row">
        <div class="col-md-4 ">
          <a href="/hotel/${booking.room.hotel.id}">
            <img src="data:image/jpeg;base64,${booking.room.hotel.hotelImageBase64Image}" alt="Hotel Photo" class="hotel-photo">
          </a>
        </div>
        <div class="col-md-8 ">
