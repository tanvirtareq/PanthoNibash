...
<form:form action="${formPostUrl}" method="post" modelAttribute="booking">
    <div class="container-xxl booking-info">
        <div id="bookingContainer" style="padding: 20px;">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="h4">Booking Information</div>
                            <div class="p"><strong>Check-in Date:</strong> ${booking.checkInDate}</div>
                            <div class="p"><strong>Check-out Date:</strong>
        ...
        <div style="display: flex; justify-content: center; margin-top: 2rem;">
            ...
            <a href="/booking/${booking.id}" class="btn btn-primary">Cancel</a>
        </div>
    </div>
</form:form>
